import { Banner } from "@base/components";
import DiscoverItem, { DiscoverItemProps } from "./discover-item";
import ProductGrid from "./product-grid";
import { GetProductRequest } from "./product.service";
  ...
  return (
    <>
      ...
      <div className="flex h-[80px] gap-4">
        <img src='/images/headlines/online-pay.svg' alt="online payment" width={50} height={50} className="self-end"></img>
      ...
      <div className="flex h-[80px] gap-4">
        <img src='/images/headlines/discount.svg' alt="discount" width={50} height={50} className="self-end"></img>
        <div className="flex flex-col justify-center self-start">
      ...
      <div className="flex h-[80px] gap-4">
        <img src='/images/headlines/quality.svg' alt="quality" width={50} height={50} className="self-end"></img>
        <div className="flex flex-col justify-center self-start">
      ...
      <div className="flex h-[80px] gap-4">
        <img src='/images/headlines/delivery.svg' alt="delivery" width={50} height={50} className="self-end"></img>   
        <div className="flex flex-col justify-center self-start">
    ...
    <div>
      ...
      <ProductGrid className='grid grid-cols-6 border border-gray-300 rounded-md' request={getArrivalRequest} />
    </div>
    ...
    <div>
      ...
      <ProductGrid className='grid grid-cols-5 border border-gray-300 rounded-md' request={getBestSellerRequest} />
    </div>
    </>
  );
}
