...
//    //TODO: Put Mongo driver into repository instead of service
...
//        private Task BatchHashingProductIdAsync(IDictionary<VirtualNode<Server>, List<ObjectId>> storage,
...
//        private Task BatchHashingProductItemAsync(IDictionary<Server, List<ProductItem>> storage,
//            IEnumerable<ProductItem> products)
//        {
//            return Task.Run(() =>
//            {
...
//                return AppResult.Success($"Done: 0");
...
//            return AppResult.Success($"Done: {count}");
//        }
