...
namespace Core.Mediator
{
    ...
    {
        public abstract Task<TResponse> HandleAsync(object request, CancellationToken cancellationToken);
    }
        ...
        public Task Handle(IRequest request, CancellationToken cancellationToken)
        {
            ...
            return serviceProvider
                ...
                .Aggregate((RequestHandlerDelegate<object?>)Handler,
                    (next, pipeline) => (t) => pipeline.HandleAsync((TRequest)request, next, t == default ? cancellationToken : t))();
        }
        ...
        where TRequest : IRequest<TResponse>
    {
        ...
        public override async Task<TResponse> HandleAsync(object request, CancellationToken cancellationToken)
        {
